...
export default function HomePage() {
	return (
		<div className="mt-40 flex min-h-screen w-full flex-col px-26 py-16">
			<div className="flex w-full flex-col gap-2 md:w-1/2 lg:w-1/3 items-start">
				<h1 className="text-4xl font-bold text-left">Amaru</h1>
				<h2 className="text-2xl text-left">Gmail Agent</h2>
