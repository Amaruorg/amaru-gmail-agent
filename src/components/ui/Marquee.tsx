...
function Marquee({ items }: MarqueeProps) {
	...
	return (
		<div className="bg-primary text-background relative w-full overflow-hidden" style={{ height: "36px" }}>
			<div
				className="animate-marquee absolute top-0 left-0 flex h-full items-center gap-4 whitespace-nowrap"
				style={{
